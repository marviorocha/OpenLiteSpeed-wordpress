            ...
            <div class="column is-half">
                <div class="card is-flex">
                    <div class="card-content">
                        ...
                        <div class="content">
                            <h3>Turbo performace</h3>
                            <i class="el  el-chevron-right"></i> <a target="_blank" href="<?php echo esc_url('https://stationpro.co'); ?>">

                                <?php echo __('<b>TurboPerfomace</b> <img style=" display:block; width: 150px;" src="https://res.cloudinary.com/station-pro/image/upload/v1739365682/plugin_station_pro_content/turbo_hotwired_pi517n.gif" alt="Turbo Performace" width="100" height="85" /> Keep your radio more fast with turbo perfomace upgrade to premium now!', 'stationpro') ?></a>
                        </div>
