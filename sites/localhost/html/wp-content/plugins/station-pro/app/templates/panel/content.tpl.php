...
<div class="redux-main">
    ...
    <?php foreach ($this->parent->sections as $k => $section) { ?>
        ...
        <div id="<?php echo esc_attr($k); ?>_section_group" class=" redux-group-tab
        <?php echo esc_attr($disabled); ?><?php echo esc_attr($section['class']); ?>" data-rel="<?php echo esc_attr($k); ?>">
